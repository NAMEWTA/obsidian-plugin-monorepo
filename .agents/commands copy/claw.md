...
2. Loads conversation history from `~/.agents/claw/{session}.md`
...
Sessions are stored as Markdown files in `~/.agents/claw/`:

```
~/.agents/claw/default.md
~/.agents/claw/my-project.md
```
