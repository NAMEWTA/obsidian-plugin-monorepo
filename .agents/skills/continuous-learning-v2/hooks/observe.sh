...
#     "PreToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": "~/.agents/skills/continuous-learning-v2/hooks/observe.sh pre" }]
#     }],
#     "PostToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": "~/.agents/skills/continuous-learning-v2/hooks/observe.sh post" }]
#     }]
#   }
# }
...
CONFIG_DIR="${HOME}/.agents/homunculus"
