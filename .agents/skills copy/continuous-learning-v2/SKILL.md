...
**If installed manually** to `~/.agents/skills`:
...
```json
{
  "hooks": {
    "PreToolUse": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "~/.agents/skills/continuous-learning-v2/hooks/observe.sh pre"
      }]
    }],
    "PostToolUse": [{
      "matcher": "*",
      "hooks": [{
        "type": "command",
        "command": "~/.agents/skills/continuous-learning-v2/hooks/observe.sh post"
      }]
    }]
  }
}
...
```bash
mkdir -p ~/.agents/homunculus/{instincts/{personal,inherited},evolved/{agents,skills,commands}}
touch ~/.agents/homunculus/observations.jsonl
```
...
```json
{
  ...
  "observation": {
    "enabled": true,
    "store_path": "~/.agents/homunculus/observations.jsonl",
    "max_file_size_mb": 10,
    "archive_after_days": 7
  },
  "instincts": {
    "personal_path": "~/.agents/homunculus/instincts/personal/",
    "inherited_path": "~/.agents/homunculus/instincts/inherited/",
    "min_confidence": 0.3,
  ...
  "evolution": {
    "cluster_threshold": 3,
    "evolved_path": "~/.agents/homunculus/evolved/"
  }
}
```
