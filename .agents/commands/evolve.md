...
1. Read all instincts from `~/.agents/homunculus/instincts/`
...
3. For each cluster of 3+ related instincts:
   ...
   - Save to `~/.agents/homunculus/evolved/{commands,skills,agents}/`
...
Files:
  - ~/.agents/homunculus/evolved/commands/new-table.md
...
Files:
  - ~/.agents/homunculus/evolved/skills/functional-patterns.md
...
Files:
  - ~/.agents/homunculus/evolved/agents/debugger.md
